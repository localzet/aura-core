...
var file_app_commander_config_proto_goTypes = []any{
	(*Config)(nil),              // 0: aura.app.commander.Config
	(*ReflectionConfig)(nil),    // 1: aura.app.commander.ReflectionConfig
	(*serial.TypedMessage)(nil), // 2: aura.common.serial.TypedMessage
}
var file_app_commander_config_proto_depIdxs = []int32{
	2, // 0: aura.app.commander.Config.service:type_name -> aura.common.serial.TypedMessage
