...
var file_app_dispatcher_config_proto_goTypes = []any{
	(*SessionConfig)(nil), // 0: aura.app.dispatcher.SessionConfig
	(*Config)(nil),        // 1: aura.app.dispatcher.Config
}
var file_app_dispatcher_config_proto_depIdxs = []int32{
	0, // 0: aura.app.dispatcher.Config.settings:type_name -> aura.app.dispatcher.SessionConfig
