...
import (
	router "github.com/localzet/aura/app/router"
...
type NameServer struct {
	...
	QueryStrategy     QueryStrategy                `protobuf:"varint,7,opt,name=query_strategy,json=queryStrategy,proto3,enum=aura.app.dns.QueryStrategy" json:"query_strategy,omitempty"`
...
type Config struct {
	...
	QueryStrategy          QueryStrategy `protobuf:"varint,9,opt,name=query_strategy,json=queryStrategy,proto3,enum=aura.app.dns.QueryStrategy" json:"query_strategy,omitempty"`
...
type NameServer_PriorityDomain struct {
	...
	Type   DomainMatchingType `protobuf:"varint,1,opt,name=type,proto3,enum=aura.app.dns.DomainMatchingType" json:"type,omitempty"`
...
type Config_HostMapping struct {
	...
	// domain. Aura will use this domain for IP queries.
...
var file_app_dns_config_proto_goTypes = []any{
	(DomainMatchingType)(0),           // 0: aura.app.dns.DomainMatchingType
	(QueryStrategy)(0),                // 1: aura.app.dns.QueryStrategy
	(*NameServer)(nil),                // 2: aura.app.dns.NameServer
	(*Config)(nil),                    // 3: aura.app.dns.Config
	(*NameServer_PriorityDomain)(nil), // 4: aura.app.dns.NameServer.PriorityDomain
	(*NameServer_OriginalRule)(nil),   // 5: aura.app.dns.NameServer.OriginalRule
	(*Config_HostMapping)(nil),        // 6: aura.app.dns.Config.HostMapping
	(*net.Endpoint)(nil),              // 7: aura.common.net.Endpoint
	(*router.GeoIP)(nil),              // 8: aura.app.router.GeoIP
}
var file_app_dns_config_proto_depIdxs = []int32{
	7,  // 0: aura.app.dns.NameServer.address:type_name -> aura.common.net.Endpoint
	4,  // 1: aura.app.dns.NameServer.prioritized_domain:type_name -> aura.app.dns.NameServer.PriorityDomain
	8,  // 2: aura.app.dns.NameServer.expected_geoip:type_name -> aura.app.router.GeoIP
	5,  // 3: aura.app.dns.NameServer.original_rules:type_name -> aura.app.dns.NameServer.OriginalRule
	1,  // 4: aura.app.dns.NameServer.query_strategy:type_name -> aura.app.dns.QueryStrategy
	8,  // 5: aura.app.dns.NameServer.unexpected_geoip:type_name -> aura.app.router.GeoIP
	2,  // 6: aura.app.dns.Config.name_server:type_name -> aura.app.dns.NameServer
	6,  // 7: aura.app.dns.Config.static_hosts:type_name -> aura.app.dns.Config.HostMapping
	1,  // 8: aura.app.dns.Config.query_strategy:type_name -> aura.app.dns.QueryStrategy
	0,  // 9: aura.app.dns.NameServer.PriorityDomain.type:type_name -> aura.app.dns.DomainMatchingType
	0,  // 10: aura.app.dns.Config.HostMapping.type:type_name -> aura.app.dns.DomainMatchingType
