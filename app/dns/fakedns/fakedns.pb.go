...
var file_app_dns_fakedns_fakedns_proto_goTypes = []any{
	(*FakeDnsPool)(nil),      // 0: aura.app.dns.fakedns.FakeDnsPool
	(*FakeDnsPoolMulti)(nil), // 1: aura.app.dns.fakedns.FakeDnsPoolMulti
}
var file_app_dns_fakedns_fakedns_proto_depIdxs = []int32{
	0, // 0: aura.app.dns.fakedns.FakeDnsPoolMulti.pools:type_name -> aura.app.dns.fakedns.FakeDnsPool
