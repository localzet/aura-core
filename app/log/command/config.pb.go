...
var file_app_log_command_config_proto_goTypes = []any{
	(*Config)(nil),                // 0: aura.app.log.command.Config
	(*RestartLoggerRequest)(nil),  // 1: aura.app.log.command.RestartLoggerRequest
	(*RestartLoggerResponse)(nil), // 2: aura.app.log.command.RestartLoggerResponse
}
var file_app_log_command_config_proto_depIdxs = []int32{
	1, // 0: aura.app.log.command.LoggerService.RestartLogger:input_type -> aura.app.log.command.RestartLoggerRequest
	2, // 1: aura.app.log.command.LoggerService.RestartLogger:output_type -> aura.app.log.command.RestartLoggerResponse
