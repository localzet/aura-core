...
import (
	log "github.com/localzet/aura/common/log"
...
type Config struct {
	...
	ErrorLogType  LogType      `protobuf:"varint,1,opt,name=error_log_type,json=errorLogType,proto3,enum=aura.app.log.LogType" json:"error_log_type,omitempty"`
	ErrorLogLevel log.Severity `protobuf:"varint,2,opt,name=error_log_level,json=errorLogLevel,proto3,enum=aura.common.log.Severity" json:"error_log_level,omitempty"`
	ErrorLogPath  string       `protobuf:"bytes,3,opt,name=error_log_path,json=errorLogPath,proto3" json:"error_log_path,omitempty"`
	AccessLogType LogType      `protobuf:"varint,4,opt,name=access_log_type,json=accessLogType,proto3,enum=aura.app.log.LogType" json:"access_log_type,omitempty"`
...
var file_app_log_config_proto_goTypes = []any{
	(LogType)(0),      // 0: aura.app.log.LogType
	(*Config)(nil),    // 1: aura.app.log.Config
	(log.Severity)(0), // 2: aura.common.log.Severity
}
var file_app_log_config_proto_depIdxs = []int32{
	0, // 0: aura.app.log.Config.error_log_type:type_name -> aura.app.log.LogType
	2, // 1: aura.app.log.Config.error_log_level:type_name -> aura.common.log.Severity
	0, // 2: aura.app.log.Config.access_log_type:type_name -> aura.app.log.LogType
