...
var file_app_observatory_burst_config_proto_goTypes = []any{
	(*Config)(nil),           // 0: aura.core.app.observatory.burst.Config
	(*HealthPingConfig)(nil), // 1: aura.core.app.observatory.burst.HealthPingConfig
}
var file_app_observatory_burst_config_proto_depIdxs = []int32{
	1, // 0: aura.core.app.observatory.burst.Config.ping_config:type_name -> aura.core.app.observatory.burst.HealthPingConfig
