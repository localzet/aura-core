...
import (
	observatory "github.com/localzet/aura/app/observatory"
...
var file_app_observatory_command_command_proto_goTypes = []any{
	(*GetOutboundStatusRequest)(nil),      // 0: aura.core.app.observatory.command.GetOutboundStatusRequest
	(*GetOutboundStatusResponse)(nil),     // 1: aura.core.app.observatory.command.GetOutboundStatusResponse
	(*Config)(nil),                        // 2: aura.core.app.observatory.command.Config
	(*observatory.ObservationResult)(nil), // 3: aura.core.app.observatory.ObservationResult
}
var file_app_observatory_command_command_proto_depIdxs = []int32{
	3, // 0: aura.core.app.observatory.command.GetOutboundStatusResponse.status:type_name -> aura.core.app.observatory.ObservationResult
	0, // 1: aura.core.app.observatory.command.ObservatoryService.GetOutboundStatus:input_type -> aura.core.app.observatory.command.GetOutboundStatusRequest
	1, // 2: aura.core.app.observatory.command.ObservatoryService.GetOutboundStatus:output_type -> aura.core.app.observatory.command.GetOutboundStatusResponse
