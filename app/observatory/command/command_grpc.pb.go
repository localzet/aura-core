...
const (
	ObservatoryService_GetOutboundStatus_FullMethodName = "/aura.core.app.observatory.command.ObservatoryService/GetOutboundStatus"
)
...
var ObservatoryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "aura.core.app.observatory.command.ObservatoryService",
