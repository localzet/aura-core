...
var file_app_observatory_config_proto_goTypes = []any{
	(*ObservationResult)(nil),           // 0: aura.core.app.observatory.ObservationResult
	(*HealthPingMeasurementResult)(nil), // 1: aura.core.app.observatory.HealthPingMeasurementResult
	(*OutboundStatus)(nil),              // 2: aura.core.app.observatory.OutboundStatus
	(*ProbeResult)(nil),                 // 3: aura.core.app.observatory.ProbeResult
	(*Intensity)(nil),                   // 4: aura.core.app.observatory.Intensity
	(*Config)(nil),                      // 5: aura.core.app.observatory.Config
}
var file_app_observatory_config_proto_depIdxs = []int32{
	2, // 0: aura.core.app.observatory.ObservationResult.status:type_name -> aura.core.app.observatory.OutboundStatus
	1, // 1: aura.core.app.observatory.OutboundStatus.health_ping:type_name -> aura.core.app.observatory.HealthPingMeasurementResult
