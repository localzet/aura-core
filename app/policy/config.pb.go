...
var file_app_policy_config_proto_goTypes = []any{
	(*Second)(nil),             // 0: aura.app.policy.Second
	(*Policy)(nil),             // 1: aura.app.policy.Policy
	(*SystemPolicy)(nil),       // 2: aura.app.policy.SystemPolicy
	(*Config)(nil),             // 3: aura.app.policy.Config
	(*Policy_Timeout)(nil),     // 4: aura.app.policy.Policy.Timeout
	(*Policy_Stats)(nil),       // 5: aura.app.policy.Policy.Stats
	(*Policy_Buffer)(nil),      // 6: aura.app.policy.Policy.Buffer
	(*SystemPolicy_Stats)(nil), // 7: aura.app.policy.SystemPolicy.Stats
	nil,                        // 8: aura.app.policy.Config.LevelEntry
}
var file_app_policy_config_proto_depIdxs = []int32{
	4,  // 0: aura.app.policy.Policy.timeout:type_name -> aura.app.policy.Policy.Timeout
	5,  // 1: aura.app.policy.Policy.stats:type_name -> aura.app.policy.Policy.Stats
	6,  // 2: aura.app.policy.Policy.buffer:type_name -> aura.app.policy.Policy.Buffer
	7,  // 3: aura.app.policy.SystemPolicy.stats:type_name -> aura.app.policy.SystemPolicy.Stats
	8,  // 4: aura.app.policy.Config.level:type_name -> aura.app.policy.Config.LevelEntry
	2,  // 5: aura.app.policy.Config.system:type_name -> aura.app.policy.SystemPolicy
	0,  // 6: aura.app.policy.Policy.Timeout.handshake:type_name -> aura.app.policy.Second
	0,  // 7: aura.app.policy.Policy.Timeout.connection_idle:type_name -> aura.app.policy.Second
	0,  // 8: aura.app.policy.Policy.Timeout.uplink_only:type_name -> aura.app.policy.Second
	0,  // 9: aura.app.policy.Policy.Timeout.downlink_only:type_name -> aura.app.policy.Second
	1,  // 10: aura.app.policy.Config.LevelEntry.value:type_name -> aura.app.policy.Policy
