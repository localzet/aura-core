...
import (
	protocol "github.com/localzet/aura/common/protocol"
	serial "github.com/localzet/aura/common/serial"
...
var file_app_proxyman_command_command_proto_goTypes = []any{
	(*AddUserOperation)(nil),             // 0: aura.app.proxyman.command.AddUserOperation
	(*RemoveUserOperation)(nil),          // 1: aura.app.proxyman.command.RemoveUserOperation
	(*AddInboundRequest)(nil),            // 2: aura.app.proxyman.command.AddInboundRequest
	(*AddInboundResponse)(nil),           // 3: aura.app.proxyman.command.AddInboundResponse
	(*RemoveInboundRequest)(nil),         // 4: aura.app.proxyman.command.RemoveInboundRequest
	(*RemoveInboundResponse)(nil),        // 5: aura.app.proxyman.command.RemoveInboundResponse
	(*AlterInboundRequest)(nil),          // 6: aura.app.proxyman.command.AlterInboundRequest
	(*AlterInboundResponse)(nil),         // 7: aura.app.proxyman.command.AlterInboundResponse
	(*ListInboundsRequest)(nil),          // 8: aura.app.proxyman.command.ListInboundsRequest
	(*ListInboundsResponse)(nil),         // 9: aura.app.proxyman.command.ListInboundsResponse
	(*GetInboundUserRequest)(nil),        // 10: aura.app.proxyman.command.GetInboundUserRequest
	(*GetInboundUserResponse)(nil),       // 11: aura.app.proxyman.command.GetInboundUserResponse
	(*GetInboundUsersCountResponse)(nil), // 12: aura.app.proxyman.command.GetInboundUsersCountResponse
	(*AddOutboundRequest)(nil),           // 13: aura.app.proxyman.command.AddOutboundRequest
	(*AddOutboundResponse)(nil),          // 14: aura.app.proxyman.command.AddOutboundResponse
	(*RemoveOutboundRequest)(nil),        // 15: aura.app.proxyman.command.RemoveOutboundRequest
	(*RemoveOutboundResponse)(nil),       // 16: aura.app.proxyman.command.RemoveOutboundResponse
	(*AlterOutboundRequest)(nil),         // 17: aura.app.proxyman.command.AlterOutboundRequest
	(*AlterOutboundResponse)(nil),        // 18: aura.app.proxyman.command.AlterOutboundResponse
	(*ListOutboundsRequest)(nil),         // 19: aura.app.proxyman.command.ListOutboundsRequest
	(*ListOutboundsResponse)(nil),        // 20: aura.app.proxyman.command.ListOutboundsResponse
	(*Config)(nil),                       // 21: aura.app.proxyman.command.Config
	(*protocol.User)(nil),                // 22: aura.common.protocol.User
	(*core.InboundHandlerConfig)(nil),    // 23: aura.core.InboundHandlerConfig
	(*serial.TypedMessage)(nil),          // 24: aura.common.serial.TypedMessage
	(*core.OutboundHandlerConfig)(nil),   // 25: aura.core.OutboundHandlerConfig
}
var file_app_proxyman_command_command_proto_depIdxs = []int32{
	22, // 0: aura.app.proxyman.command.AddUserOperation.user:type_name -> aura.common.protocol.User
	23, // 1: aura.app.proxyman.command.AddInboundRequest.inbound:type_name -> aura.core.InboundHandlerConfig
	24, // 2: aura.app.proxyman.command.AlterInboundRequest.operation:type_name -> aura.common.serial.TypedMessage
	23, // 3: aura.app.proxyman.command.ListInboundsResponse.inbounds:type_name -> aura.core.InboundHandlerConfig
	22, // 4: aura.app.proxyman.command.GetInboundUserResponse.users:type_name -> aura.common.protocol.User
	25, // 5: aura.app.proxyman.command.AddOutboundRequest.outbound:type_name -> aura.core.OutboundHandlerConfig
	24, // 6: aura.app.proxyman.command.AlterOutboundRequest.operation:type_name -> aura.common.serial.TypedMessage
	25, // 7: aura.app.proxyman.command.ListOutboundsResponse.outbounds:type_name -> aura.core.OutboundHandlerConfig
	2,  // 8: aura.app.proxyman.command.HandlerService.AddInbound:input_type -> aura.app.proxyman.command.AddInboundRequest
	4,  // 9: aura.app.proxyman.command.HandlerService.RemoveInbound:input_type -> aura.app.proxyman.command.RemoveInboundRequest
	6,  // 10: aura.app.proxyman.command.HandlerService.AlterInbound:input_type -> aura.app.proxyman.command.AlterInboundRequest
	8,  // 11: aura.app.proxyman.command.HandlerService.ListInbounds:input_type -> aura.app.proxyman.command.ListInboundsRequest
	10, // 12: aura.app.proxyman.command.HandlerService.GetInboundUsers:input_type -> aura.app.proxyman.command.GetInboundUserRequest
	10, // 13: aura.app.proxyman.command.HandlerService.GetInboundUsersCount:input_type -> aura.app.proxyman.command.GetInboundUserRequest
	13, // 14: aura.app.proxyman.command.HandlerService.AddOutbound:input_type -> aura.app.proxyman.command.AddOutboundRequest
	15, // 15: aura.app.proxyman.command.HandlerService.RemoveOutbound:input_type -> aura.app.proxyman.command.RemoveOutboundRequest
	17, // 16: aura.app.proxyman.command.HandlerService.AlterOutbound:input_type -> aura.app.proxyman.command.AlterOutboundRequest
	19, // 17: aura.app.proxyman.command.HandlerService.ListOutbounds:input_type -> aura.app.proxyman.command.ListOutboundsRequest
	3,  // 18: aura.app.proxyman.command.HandlerService.AddInbound:output_type -> aura.app.proxyman.command.AddInboundResponse
	5,  // 19: aura.app.proxyman.command.HandlerService.RemoveInbound:output_type -> aura.app.proxyman.command.RemoveInboundResponse
	7,  // 20: aura.app.proxyman.command.HandlerService.AlterInbound:output_type -> aura.app.proxyman.command.AlterInboundResponse
	9,  // 21: aura.app.proxyman.command.HandlerService.ListInbounds:output_type -> aura.app.proxyman.command.ListInboundsResponse
	11, // 22: aura.app.proxyman.command.HandlerService.GetInboundUsers:output_type -> aura.app.proxyman.command.GetInboundUserResponse
	12, // 23: aura.app.proxyman.command.HandlerService.GetInboundUsersCount:output_type -> aura.app.proxyman.command.GetInboundUsersCountResponse
	14, // 24: aura.app.proxyman.command.HandlerService.AddOutbound:output_type -> aura.app.proxyman.command.AddOutboundResponse
	16, // 25: aura.app.proxyman.command.HandlerService.RemoveOutbound:output_type -> aura.app.proxyman.command.RemoveOutboundResponse
	18, // 26: aura.app.proxyman.command.HandlerService.AlterOutbound:output_type -> aura.app.proxyman.command.AlterOutboundResponse
	20, // 27: aura.app.proxyman.command.HandlerService.ListOutbounds:output_type -> aura.app.proxyman.command.ListOutboundsResponse
