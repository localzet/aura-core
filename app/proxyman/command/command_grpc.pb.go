...
const (
	HandlerService_AddInbound_FullMethodName           = "/aura.app.proxyman.command.HandlerService/AddInbound"
	HandlerService_RemoveInbound_FullMethodName        = "/aura.app.proxyman.command.HandlerService/RemoveInbound"
	HandlerService_AlterInbound_FullMethodName         = "/aura.app.proxyman.command.HandlerService/AlterInbound"
	HandlerService_ListInbounds_FullMethodName         = "/aura.app.proxyman.command.HandlerService/ListInbounds"
	HandlerService_GetInboundUsers_FullMethodName      = "/aura.app.proxyman.command.HandlerService/GetInboundUsers"
	HandlerService_GetInboundUsersCount_FullMethodName = "/aura.app.proxyman.command.HandlerService/GetInboundUsersCount"
	HandlerService_AddOutbound_FullMethodName          = "/aura.app.proxyman.command.HandlerService/AddOutbound"
	HandlerService_RemoveOutbound_FullMethodName       = "/aura.app.proxyman.command.HandlerService/RemoveOutbound"
	HandlerService_AlterOutbound_FullMethodName        = "/aura.app.proxyman.command.HandlerService/AlterOutbound"
	HandlerService_ListOutbounds_FullMethodName        = "/aura.app.proxyman.command.HandlerService/ListOutbounds"
)
...
var HandlerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "aura.app.proxyman.command.HandlerService",
