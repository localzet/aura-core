...
import (
	...
	internet "github.com/localzet/aura/transport/internet"
...
type AllocationStrategy struct {
	...
	Type AllocationStrategy_Type `protobuf:"varint,1,opt,name=type,proto3,enum=aura.app.proxyman.AllocationStrategy_Type" json:"type,omitempty"`
...
var file_app_proxyman_config_proto_goTypes = []any{
	(AllocationStrategy_Type)(0),                             // 0: aura.app.proxyman.AllocationStrategy.Type
	(*InboundConfig)(nil),                                    // 1: aura.app.proxyman.InboundConfig
	(*AllocationStrategy)(nil),                               // 2: aura.app.proxyman.AllocationStrategy
	(*SniffingConfig)(nil),                                   // 3: aura.app.proxyman.SniffingConfig
	(*ReceiverConfig)(nil),                                   // 4: aura.app.proxyman.ReceiverConfig
	(*InboundHandlerConfig)(nil),                             // 5: aura.app.proxyman.InboundHandlerConfig
	(*OutboundConfig)(nil),                                   // 6: aura.app.proxyman.OutboundConfig
	(*SenderConfig)(nil),                                     // 7: aura.app.proxyman.SenderConfig
	(*MultiplexingConfig)(nil),                               // 8: aura.app.proxyman.MultiplexingConfig
	(*AllocationStrategy_AllocationStrategyConcurrency)(nil), // 9: aura.app.proxyman.AllocationStrategy.AllocationStrategyConcurrency
	(*AllocationStrategy_AllocationStrategyRefresh)(nil),     // 10: aura.app.proxyman.AllocationStrategy.AllocationStrategyRefresh
	(*net.PortList)(nil),                                     // 11: aura.common.net.PortList
	(*net.IPOrDomain)(nil),                                   // 12: aura.common.net.IPOrDomain
	(*internet.StreamConfig)(nil),                            // 13: aura.transport.internet.StreamConfig
	(*serial.TypedMessage)(nil),                              // 14: aura.common.serial.TypedMessage
	(*internet.ProxyConfig)(nil),                             // 15: aura.transport.internet.ProxyConfig
}
var file_app_proxyman_config_proto_depIdxs = []int32{
	0,  // 0: aura.app.proxyman.AllocationStrategy.type:type_name -> aura.app.proxyman.AllocationStrategy.Type
	9,  // 1: aura.app.proxyman.AllocationStrategy.concurrency:type_name -> aura.app.proxyman.AllocationStrategy.AllocationStrategyConcurrency
	10, // 2: aura.app.proxyman.AllocationStrategy.refresh:type_name -> aura.app.proxyman.AllocationStrategy.AllocationStrategyRefresh
	11, // 3: aura.app.proxyman.ReceiverConfig.port_list:type_name -> aura.common.net.PortList
	12, // 4: aura.app.proxyman.ReceiverConfig.listen:type_name -> aura.common.net.IPOrDomain
	2,  // 5: aura.app.proxyman.ReceiverConfig.allocation_strategy:type_name -> aura.app.proxyman.AllocationStrategy
	13, // 6: aura.app.proxyman.ReceiverConfig.stream_settings:type_name -> aura.transport.internet.StreamConfig
	3,  // 7: aura.app.proxyman.ReceiverConfig.sniffing_settings:type_name -> aura.app.proxyman.SniffingConfig
	14, // 8: aura.app.proxyman.InboundHandlerConfig.receiver_settings:type_name -> aura.common.serial.TypedMessage
	14, // 9: aura.app.proxyman.InboundHandlerConfig.proxy_settings:type_name -> aura.common.serial.TypedMessage
	12, // 10: aura.app.proxyman.SenderConfig.via:type_name -> aura.common.net.IPOrDomain
	13, // 11: aura.app.proxyman.SenderConfig.stream_settings:type_name -> aura.transport.internet.StreamConfig
	15, // 12: aura.app.proxyman.SenderConfig.proxy_settings:type_name -> aura.transport.internet.ProxyConfig
	8,  // 13: aura.app.proxyman.SenderConfig.multiplex_settings:type_name -> aura.app.proxyman.MultiplexingConfig
