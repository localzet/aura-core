...
type Control struct {
	...
	State  Control_State `protobuf:"varint,1,opt,name=state,proto3,enum=aura.app.reverse.Control_State" json:"state,omitempty"`
...
var file_app_reverse_config_proto_goTypes = []any{
	(Control_State)(0),   // 0: aura.app.reverse.Control.State
	(*Control)(nil),      // 1: aura.app.reverse.Control
	(*BridgeConfig)(nil), // 2: aura.app.reverse.BridgeConfig
	(*PortalConfig)(nil), // 3: aura.app.reverse.PortalConfig
	(*Config)(nil),       // 4: aura.app.reverse.Config
}
var file_app_reverse_config_proto_depIdxs = []int32{
	0, // 0: aura.app.reverse.Control.state:type_name -> aura.app.reverse.Control.State
	2, // 1: aura.app.reverse.Config.bridge_config:type_name -> aura.app.reverse.BridgeConfig
	3, // 2: aura.app.reverse.Config.portal_config:type_name -> aura.app.reverse.PortalConfig
