...
import (
	net "github.com/localzet/aura/common/net"
...
// It conforms to the structure of aura.features.routing.Context and
// aura.features.routing.Route.
type RoutingContext struct {
	...
	Network           net.Network       `protobuf:"varint,2,opt,name=Network,proto3,enum=aura.common.net.Network" json:"Network,omitempty"`
...
var file_app_router_command_command_proto_goTypes = []any{
	(*RoutingContext)(nil),                 // 0: aura.app.router.command.RoutingContext
	(*SubscribeRoutingStatsRequest)(nil),   // 1: aura.app.router.command.SubscribeRoutingStatsRequest
	(*TestRouteRequest)(nil),               // 2: aura.app.router.command.TestRouteRequest
	(*PrincipleTargetInfo)(nil),            // 3: aura.app.router.command.PrincipleTargetInfo
	(*OverrideInfo)(nil),                   // 4: aura.app.router.command.OverrideInfo
	(*BalancerMsg)(nil),                    // 5: aura.app.router.command.BalancerMsg
	(*GetBalancerInfoRequest)(nil),         // 6: aura.app.router.command.GetBalancerInfoRequest
	(*GetBalancerInfoResponse)(nil),        // 7: aura.app.router.command.GetBalancerInfoResponse
	(*OverrideBalancerTargetRequest)(nil),  // 8: aura.app.router.command.OverrideBalancerTargetRequest
	(*OverrideBalancerTargetResponse)(nil), // 9: aura.app.router.command.OverrideBalancerTargetResponse
	(*AddRuleRequest)(nil),                 // 10: aura.app.router.command.AddRuleRequest
	(*AddRuleResponse)(nil),                // 11: aura.app.router.command.AddRuleResponse
	(*RemoveRuleRequest)(nil),              // 12: aura.app.router.command.RemoveRuleRequest
	(*RemoveRuleResponse)(nil),             // 13: aura.app.router.command.RemoveRuleResponse
	(*Config)(nil),                         // 14: aura.app.router.command.Config
	nil,                                    // 15: aura.app.router.command.RoutingContext.AttributesEntry
	(net.Network)(0),                       // 16: aura.common.net.Network
	(*serial.TypedMessage)(nil),            // 17: aura.common.serial.TypedMessage
}
var file_app_router_command_command_proto_depIdxs = []int32{
	16, // 0: aura.app.router.command.RoutingContext.Network:type_name -> aura.common.net.Network
	15, // 1: aura.app.router.command.RoutingContext.Attributes:type_name -> aura.app.router.command.RoutingContext.AttributesEntry
	0,  // 2: aura.app.router.command.TestRouteRequest.RoutingContext:type_name -> aura.app.router.command.RoutingContext
	4,  // 3: aura.app.router.command.BalancerMsg.override:type_name -> aura.app.router.command.OverrideInfo
	3,  // 4: aura.app.router.command.BalancerMsg.principle_target:type_name -> aura.app.router.command.PrincipleTargetInfo
	5,  // 5: aura.app.router.command.GetBalancerInfoResponse.balancer:type_name -> aura.app.router.command.BalancerMsg
	17, // 6: aura.app.router.command.AddRuleRequest.config:type_name -> aura.common.serial.TypedMessage
	1,  // 7: aura.app.router.command.RoutingService.SubscribeRoutingStats:input_type -> aura.app.router.command.SubscribeRoutingStatsRequest
	2,  // 8: aura.app.router.command.RoutingService.TestRoute:input_type -> aura.app.router.command.TestRouteRequest
	6,  // 9: aura.app.router.command.RoutingService.GetBalancerInfo:input_type -> aura.app.router.command.GetBalancerInfoRequest
	8,  // 10: aura.app.router.command.RoutingService.OverrideBalancerTarget:input_type -> aura.app.router.command.OverrideBalancerTargetRequest
	10, // 11: aura.app.router.command.RoutingService.AddRule:input_type -> aura.app.router.command.AddRuleRequest
	12, // 12: aura.app.router.command.RoutingService.RemoveRule:input_type -> aura.app.router.command.RemoveRuleRequest
	0,  // 13: aura.app.router.command.RoutingService.SubscribeRoutingStats:output_type -> aura.app.router.command.RoutingContext
	0,  // 14: aura.app.router.command.RoutingService.TestRoute:output_type -> aura.app.router.command.RoutingContext
	7,  // 15: aura.app.router.command.RoutingService.GetBalancerInfo:output_type -> aura.app.router.command.GetBalancerInfoResponse
	9,  // 16: aura.app.router.command.RoutingService.OverrideBalancerTarget:output_type -> aura.app.router.command.OverrideBalancerTargetResponse
	11, // 17: aura.app.router.command.RoutingService.AddRule:output_type -> aura.app.router.command.AddRuleResponse
	13, // 18: aura.app.router.command.RoutingService.RemoveRule:output_type -> aura.app.router.command.RemoveRuleResponse
