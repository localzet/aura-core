...
const (
	RoutingService_SubscribeRoutingStats_FullMethodName  = "/aura.app.router.command.RoutingService/SubscribeRoutingStats"
	RoutingService_TestRoute_FullMethodName              = "/aura.app.router.command.RoutingService/TestRoute"
	RoutingService_GetBalancerInfo_FullMethodName        = "/aura.app.router.command.RoutingService/GetBalancerInfo"
	RoutingService_OverrideBalancerTarget_FullMethodName = "/aura.app.router.command.RoutingService/OverrideBalancerTarget"
	RoutingService_AddRule_FullMethodName                = "/aura.app.router.command.RoutingService/AddRule"
	RoutingService_RemoveRule_FullMethodName             = "/aura.app.router.command.RoutingService/RemoveRule"
)
...
var RoutingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "aura.app.router.command.RoutingService",
