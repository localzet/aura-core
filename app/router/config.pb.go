...
type Domain struct {
	...
	Type Domain_Type `protobuf:"varint,1,opt,name=type,proto3,enum=aura.app.router.Domain_Type" json:"type,omitempty"`
	// Domain value.
...
type RoutingRule struct {
	...
	Networks []net.Network `protobuf:"varint,13,rep,packed,name=networks,proto3,enum=aura.common.net.Network" json:"networks,omitempty"`
...
type Config struct {
	...
	DomainStrategy Config_DomainStrategy `protobuf:"varint,1,opt,name=domain_strategy,json=domainStrategy,proto3,enum=aura.app.router.Config_DomainStrategy" json:"domain_strategy,omitempty"`
...
var file_app_router_config_proto_goTypes = []any{
	(Domain_Type)(0),                // 0: aura.app.router.Domain.Type
	(Config_DomainStrategy)(0),      // 1: aura.app.router.Config.DomainStrategy
	(*Domain)(nil),                  // 2: aura.app.router.Domain
	(*CIDR)(nil),                    // 3: aura.app.router.CIDR
	(*GeoIP)(nil),                   // 4: aura.app.router.GeoIP
	(*GeoIPList)(nil),               // 5: aura.app.router.GeoIPList
	(*GeoSite)(nil),                 // 6: aura.app.router.GeoSite
	(*GeoSiteList)(nil),             // 7: aura.app.router.GeoSiteList
	(*RoutingRule)(nil),             // 8: aura.app.router.RoutingRule
	(*BalancingRule)(nil),           // 9: aura.app.router.BalancingRule
	(*StrategyWeight)(nil),          // 10: aura.app.router.StrategyWeight
	(*StrategyLeastLoadConfig)(nil), // 11: aura.app.router.StrategyLeastLoadConfig
	(*Config)(nil),                  // 12: aura.app.router.Config
	(*Domain_Attribute)(nil),        // 13: aura.app.router.Domain.Attribute
	nil,                             // 14: aura.app.router.RoutingRule.AttributesEntry
	(*net.PortList)(nil),            // 15: aura.common.net.PortList
...
var file_app_router_config_proto_depIdxs = []int32{
	0,  // 0: aura.app.router.Domain.type:type_name -> aura.app.router.Domain.Type
	13, // 1: aura.app.router.Domain.attribute:type_name -> aura.app.router.Domain.Attribute
	3,  // 2: aura.app.router.GeoIP.cidr:type_name -> aura.app.router.CIDR
	4,  // 3: aura.app.router.GeoIPList.entry:type_name -> aura.app.router.GeoIP
	2,  // 4: aura.app.router.GeoSite.domain:type_name -> aura.app.router.Domain
	6,  // 5: aura.app.router.GeoSiteList.entry:type_name -> aura.app.router.GeoSite
	2,  // 6: aura.app.router.RoutingRule.domain:type_name -> aura.app.router.Domain
	4,  // 7: aura.app.router.RoutingRule.geoip:type_name -> aura.app.router.GeoIP
	15, // 8: aura.app.router.RoutingRule.port_list:type_name -> aura.common.net.PortList
	16, // 9: aura.app.router.RoutingRule.networks:type_name -> aura.common.net.Network
	4,  // 10: aura.app.router.RoutingRule.source_geoip:type_name -> aura.app.router.GeoIP
	15, // 11: aura.app.router.RoutingRule.source_port_list:type_name -> aura.common.net.PortList
	14, // 12: aura.app.router.RoutingRule.attributes:type_name -> aura.app.router.RoutingRule.AttributesEntry
	17, // 13: aura.app.router.BalancingRule.strategy_settings:type_name -> aura.common.serial.TypedMessage
	10, // 14: aura.app.router.StrategyLeastLoadConfig.costs:type_name -> aura.app.router.StrategyWeight
	1,  // 15: aura.app.router.Config.domain_strategy:type_name -> aura.app.router.Config.DomainStrategy
	8,  // 16: aura.app.router.Config.rule:type_name -> aura.app.router.RoutingRule
	9,  // 17: aura.app.router.Config.balancing_rule:type_name -> aura.app.router.BalancingRule
