...
var file_app_stats_command_command_proto_goTypes = []any{
	(*GetStatsRequest)(nil),              // 0: aura.app.stats.command.GetStatsRequest
	(*Stat)(nil),                         // 1: aura.app.stats.command.Stat
	(*GetStatsResponse)(nil),             // 2: aura.app.stats.command.GetStatsResponse
	(*QueryStatsRequest)(nil),            // 3: aura.app.stats.command.QueryStatsRequest
	(*QueryStatsResponse)(nil),           // 4: aura.app.stats.command.QueryStatsResponse
	(*SysStatsRequest)(nil),              // 5: aura.app.stats.command.SysStatsRequest
	(*SysStatsResponse)(nil),             // 6: aura.app.stats.command.SysStatsResponse
	(*GetStatsOnlineIpListResponse)(nil), // 7: aura.app.stats.command.GetStatsOnlineIpListResponse
	(*Config)(nil),                       // 8: aura.app.stats.command.Config
	nil,                                  // 9: aura.app.stats.command.GetStatsOnlineIpListResponse.IpsEntry
}
var file_app_stats_command_command_proto_depIdxs = []int32{
	1, // 0: aura.app.stats.command.GetStatsResponse.stat:type_name -> aura.app.stats.command.Stat
	1, // 1: aura.app.stats.command.QueryStatsResponse.stat:type_name -> aura.app.stats.command.Stat
	9, // 2: aura.app.stats.command.GetStatsOnlineIpListResponse.ips:type_name -> aura.app.stats.command.GetStatsOnlineIpListResponse.IpsEntry
	0, // 3: aura.app.stats.command.StatsService.GetStats:input_type -> aura.app.stats.command.GetStatsRequest
	0, // 4: aura.app.stats.command.StatsService.GetStatsOnline:input_type -> aura.app.stats.command.GetStatsRequest
	3, // 5: aura.app.stats.command.StatsService.QueryStats:input_type -> aura.app.stats.command.QueryStatsRequest
	5, // 6: aura.app.stats.command.StatsService.GetSysStats:input_type -> aura.app.stats.command.SysStatsRequest
	0, // 7: aura.app.stats.command.StatsService.GetStatsOnlineIpList:input_type -> aura.app.stats.command.GetStatsRequest
	2, // 8: aura.app.stats.command.StatsService.GetStats:output_type -> aura.app.stats.command.GetStatsResponse
	2, // 9: aura.app.stats.command.StatsService.GetStatsOnline:output_type -> aura.app.stats.command.GetStatsResponse
	4, // 10: aura.app.stats.command.StatsService.QueryStats:output_type -> aura.app.stats.command.QueryStatsResponse
	6, // 11: aura.app.stats.command.StatsService.GetSysStats:output_type -> aura.app.stats.command.SysStatsResponse
	7, // 12: aura.app.stats.command.StatsService.GetStatsOnlineIpList:output_type -> aura.app.stats.command.GetStatsOnlineIpListResponse
