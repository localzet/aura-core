...
type Endpoint struct {
	...
	Network Network     `protobuf:"varint,1,opt,name=network,proto3,enum=aura.common.net.Network" json:"network,omitempty"`
...
var file_common_net_destination_proto_goTypes = []any{
	(*Endpoint)(nil),   // 0: aura.common.net.Endpoint
	(Network)(0),       // 1: aura.common.net.Network
	(*IPOrDomain)(nil), // 2: aura.common.net.IPOrDomain
}
var file_common_net_destination_proto_depIdxs = []int32{
	1, // 0: aura.common.net.Endpoint.network:type_name -> aura.common.net.Network
	2, // 1: aura.common.net.Endpoint.address:type_name -> aura.common.net.IPOrDomain
