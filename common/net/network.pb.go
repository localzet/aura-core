...
type NetworkList struct {
	...
	Network []Network `protobuf:"varint,1,rep,packed,name=network,proto3,enum=aura.common.net.Network" json:"network,omitempty"`
}
...
var file_common_net_network_proto_goTypes = []any{
	(Network)(0),        // 0: aura.common.net.Network
	(*NetworkList)(nil), // 1: aura.common.net.NetworkList
}
var file_common_net_network_proto_depIdxs = []int32{
	0, // 0: aura.common.net.NetworkList.network:type_name -> aura.common.net.Network
