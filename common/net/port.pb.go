...
var file_common_net_port_proto_goTypes = []any{
	(*PortRange)(nil), // 0: aura.common.net.PortRange
	(*PortList)(nil),  // 1: aura.common.net.PortList
}
var file_common_net_port_proto_depIdxs = []int32{
	0, // 0: aura.common.net.PortList.range:type_name -> aura.common.net.PortRange
