...
type SecurityConfig struct {
	...
	Type SecurityType `protobuf:"varint,1,opt,name=type,proto3,enum=aura.common.protocol.SecurityType" json:"type,omitempty"`
}
...
var file_common_protocol_headers_proto_goTypes = []any{
	(SecurityType)(0),      // 0: aura.common.protocol.SecurityType
	(*SecurityConfig)(nil), // 1: aura.common.protocol.SecurityConfig
}
var file_common_protocol_headers_proto_depIdxs = []int32{
	0, // 0: aura.common.protocol.SecurityConfig.type:type_name -> aura.common.protocol.SecurityType
