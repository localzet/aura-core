...
var file_common_protocol_server_spec_proto_goTypes = []any{
	(*ServerEndpoint)(nil), // 0: aura.common.protocol.ServerEndpoint
	(*net.IPOrDomain)(nil), // 1: aura.common.net.IPOrDomain
	(*User)(nil),           // 2: aura.common.protocol.User
}
var file_common_protocol_server_spec_proto_depIdxs = []int32{
	1, // 0: aura.common.protocol.ServerEndpoint.address:type_name -> aura.common.net.IPOrDomain
	2, // 1: aura.common.protocol.ServerEndpoint.user:type_name -> aura.common.protocol.User
