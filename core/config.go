...
import (
	...
	"github.com/localzet/aura/main/confloader"
	"google.golang.org/protobuf/proto"
)

// ConfigFormat is a configurable format of Aura config file.
...
// ConfigLoader is a utility to load Aura config from external source.
