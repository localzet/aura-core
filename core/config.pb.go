...
var file_core_config_proto_goTypes = []any{
	(*Config)(nil),                // 0: aura.core.Config
	(*InboundHandlerConfig)(nil),  // 1: aura.core.InboundHandlerConfig
	(*OutboundHandlerConfig)(nil), // 2: aura.core.OutboundHandlerConfig
	(*serial.TypedMessage)(nil),   // 3: aura.common.serial.TypedMessage
}
var file_core_config_proto_depIdxs = []int32{
	1, // 0: aura.core.Config.inbound:type_name -> aura.core.InboundHandlerConfig
	2, // 1: aura.core.Config.outbound:type_name -> aura.core.OutboundHandlerConfig
	3, // 2: aura.core.Config.app:type_name -> aura.common.serial.TypedMessage
	3, // 3: aura.core.Config.extension:type_name -> aura.common.serial.TypedMessage
	3, // 4: aura.core.InboundHandlerConfig.receiver_settings:type_name -> aura.common.serial.TypedMessage
	3, // 5: aura.core.InboundHandlerConfig.proxy_settings:type_name -> aura.common.serial.TypedMessage
	3, // 6: aura.core.OutboundHandlerConfig.sender_settings:type_name -> aura.common.serial.TypedMessage
	3, // 7: aura.core.OutboundHandlerConfig.proxy_settings:type_name -> aura.common.serial.TypedMessage
