...
import (
	...
	"github.com/localzet/aura/common/platform"
	...
	"github.com/localzet/aura/features/inbound"
	"github.com/localzet/aura/features/outbound"
	"github.com/localzet/aura/features/policy"
	"github.com/localzet/aura/features/routing"
	"github.com/localzet/aura/features/stats"
	"github.com/localzet/aura/transport/internet"
)

// Server is an instance of Aura. At any time, there must be at most one Server instance running.
...
// Instance combines all Aura features.
...
// New returns a new Aura instance based on given configuration.
// The instance is not started at this point.
// To ensure Aura instance works properly, the config must contain one Dispatcher, one InboundHandlerManager and one OutboundHandlerManager. Other features are optional.
...
// Close shutdown the Aura instance.
...
// Start starts the Aura instance, including all registered features. When Start returns error, the state of the instance is unknown.
// A Aura instance can be started only once. Upon closing, the instance is not guaranteed to start again.
//
// aura:api:stable
func (s *Instance) Start() error {
	...
	errors.LogWarning(s.ctx, "Aura ", Version(), " started")
