...
func TestAuraConfig(t *testing.T) {
			...
			Output: &core.Config{
				App: []*serial.TypedMessage{
					serial.ToTypedMessage(&log.Config{
						...
						ErrorLogPath:  "/var/log/aura/error.log",
						ErrorLogLevel: clog.Severity_Error,
						AccessLogType: log.LogType_File,
						AccessLogPath: "/var/log/aura/access.log",
					}),
				...
				Inbound: []*core.InboundHandlerConfig{
					{
						ReceiverSettings: serial.ToTypedMessage(&proxyman.ReceiverConfig{
							...
							StreamSettings: &internet.StreamConfig{
								...
								SecurityType: "aura.transport.internet.tls.Config",
