...
var directory = flag.String("pwd", "", "Working directory of Aura vprotogen.")
...
func getProjectProtocVersion(url string) (string, error) {
	...
	if err != nil {
		return "", errors.New("can not get the version of protobuf used in aura project")
	}
...
func main() {
	...
	/*
		targetedVersion, err := getProjectProtocVersion("https://raw.githubusercontent.com/localzet/aura/HEAD/core/config.pb.go")
		if err != nil {
			fmt.Println(err)
			os.Exit(1)
		}
...
Download it from https://github.com/protocolbuffers/protobuf/releases
    ...
    * Protobuf version used in aura project: v%s
