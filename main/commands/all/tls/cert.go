...
var (
	...
	certCommonName   = cmdCert.Flag.String("name", "Aura Inc", "The common name of this certificate")
	certOrganization = cmdCert.Flag.String("org", "Aura Inc", "Organization of the certificate")
