...
// A Command is an implementation of a aura command
// like aura run or aura version.
type Command struct {
...
// LongName returns the command's long name: all the words in the usage line between first word (e.g. "aura") and a flag or argument,
...
func (c *Command) Usage() {
	...
	fmt.Fprintf(os.Stderr, "Run 'aura help %s' for details.\n", c.LongName())
	SetExitStatus(2)
	Exit()
}
