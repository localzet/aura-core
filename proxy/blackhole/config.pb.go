...
var file_proxy_blackhole_config_proto_goTypes = []any{
	(*NoneResponse)(nil),        // 0: aura.proxy.blackhole.NoneResponse
	(*HTTPResponse)(nil),        // 1: aura.proxy.blackhole.HTTPResponse
	(*Config)(nil),              // 2: aura.proxy.blackhole.Config
	(*serial.TypedMessage)(nil), // 3: aura.common.serial.TypedMessage
}
var file_proxy_blackhole_config_proto_depIdxs = []int32{
	3, // 0: aura.proxy.blackhole.Config.response:type_name -> aura.common.serial.TypedMessage
