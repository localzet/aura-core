...
type Config struct {
	...
	Networks       []net.Network `protobuf:"varint,7,rep,packed,name=networks,proto3,enum=aura.common.net.Network" json:"networks,omitempty"`
...
var file_proxy_dokodemo_config_proto_goTypes = []any{
	(*Config)(nil),         // 0: aura.proxy.dokodemo.Config
	(*net.IPOrDomain)(nil), // 1: aura.common.net.IPOrDomain
	(net.Network)(0),       // 2: aura.common.net.Network
}
var file_proxy_dokodemo_config_proto_depIdxs = []int32{
	1, // 0: aura.proxy.dokodemo.Config.address:type_name -> aura.common.net.IPOrDomain
	2, // 1: aura.proxy.dokodemo.Config.networks:type_name -> aura.common.net.Network
