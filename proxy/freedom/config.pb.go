...
type Config struct {
	...
	DomainStrategy      Config_DomainStrategy `protobuf:"varint,1,opt,name=domain_strategy,json=domainStrategy,proto3,enum=aura.proxy.freedom.Config_DomainStrategy" json:"domain_strategy,omitempty"`
...
var file_proxy_freedom_config_proto_goTypes = []any{
	(Config_DomainStrategy)(0),      // 0: aura.proxy.freedom.Config.DomainStrategy
	(*DestinationOverride)(nil),     // 1: aura.proxy.freedom.DestinationOverride
	(*Fragment)(nil),                // 2: aura.proxy.freedom.Fragment
	(*Noise)(nil),                   // 3: aura.proxy.freedom.Noise
	(*Config)(nil),                  // 4: aura.proxy.freedom.Config
	(*protocol.ServerEndpoint)(nil), // 5: aura.common.protocol.ServerEndpoint
}
var file_proxy_freedom_config_proto_depIdxs = []int32{
	5, // 0: aura.proxy.freedom.DestinationOverride.server:type_name -> aura.common.protocol.ServerEndpoint
	0, // 1: aura.proxy.freedom.Config.domain_strategy:type_name -> aura.proxy.freedom.Config.DomainStrategy
	1, // 2: aura.proxy.freedom.Config.destination_override:type_name -> aura.proxy.freedom.DestinationOverride
	2, // 3: aura.proxy.freedom.Config.fragment:type_name -> aura.proxy.freedom.Fragment
	3, // 4: aura.proxy.freedom.Config.noises:type_name -> aura.proxy.freedom.Noise
