...
var file_proxy_http_config_proto_goTypes = []any{
	(*Account)(nil),                 // 0: aura.proxy.http.Account
	(*ServerConfig)(nil),            // 1: aura.proxy.http.ServerConfig
	(*Header)(nil),                  // 2: aura.proxy.http.Header
	(*ClientConfig)(nil),            // 3: aura.proxy.http.ClientConfig
	nil,                             // 4: aura.proxy.http.ServerConfig.AccountsEntry
	(*protocol.ServerEndpoint)(nil), // 5: aura.common.protocol.ServerEndpoint
}
var file_proxy_http_config_proto_depIdxs = []int32{
	4, // 0: aura.proxy.http.ServerConfig.accounts:type_name -> aura.proxy.http.ServerConfig.AccountsEntry
	5, // 1: aura.proxy.http.ClientConfig.server:type_name -> aura.common.protocol.ServerEndpoint
	2, // 2: aura.proxy.http.ClientConfig.header:type_name -> aura.proxy.http.Header
