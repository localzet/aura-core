...
type Account struct {
	...
	CipherType CipherType `protobuf:"varint,2,opt,name=cipher_type,json=cipherType,proto3,enum=aura.proxy.shadowsocks.CipherType" json:"cipher_type,omitempty"`
...
type ServerConfig struct {
	...
	Network []net.Network    `protobuf:"varint,2,rep,packed,name=network,proto3,enum=aura.common.net.Network" json:"network,omitempty"`
}
...
var file_proxy_shadowsocks_config_proto_goTypes = []any{
	(CipherType)(0),                 // 0: aura.proxy.shadowsocks.CipherType
	(*Account)(nil),                 // 1: aura.proxy.shadowsocks.Account
	(*ServerConfig)(nil),            // 2: aura.proxy.shadowsocks.ServerConfig
	(*ClientConfig)(nil),            // 3: aura.proxy.shadowsocks.ClientConfig
	(*protocol.User)(nil),           // 4: aura.common.protocol.User
	(net.Network)(0),                // 5: aura.common.net.Network
	(*protocol.ServerEndpoint)(nil), // 6: aura.common.protocol.ServerEndpoint
}
var file_proxy_shadowsocks_config_proto_depIdxs = []int32{
	0, // 0: aura.proxy.shadowsocks.Account.cipher_type:type_name -> aura.proxy.shadowsocks.CipherType
	4, // 1: aura.proxy.shadowsocks.ServerConfig.users:type_name -> aura.common.protocol.User
	5, // 2: aura.proxy.shadowsocks.ServerConfig.network:type_name -> aura.common.net.Network
	6, // 3: aura.proxy.shadowsocks.ClientConfig.server:type_name -> aura.common.protocol.ServerEndpoint
