...
type ServerConfig struct {
	...
	Network []net.Network `protobuf:"varint,5,rep,packed,name=network,proto3,enum=aura.common.net.Network" json:"network,omitempty"`
}
...
type MultiUserServerConfig struct {
	...
	Network []net.Network    `protobuf:"varint,4,rep,packed,name=network,proto3,enum=aura.common.net.Network" json:"network,omitempty"`
}
...
var file_proxy_shadowsocks_2022_config_proto_goTypes = []any{
	(*ServerConfig)(nil),          // 0: aura.proxy.shadowsocks_2022.ServerConfig
	(*MultiUserServerConfig)(nil), // 1: aura.proxy.shadowsocks_2022.MultiUserServerConfig
	(*RelayDestination)(nil),      // 2: aura.proxy.shadowsocks_2022.RelayDestination
	(*RelayServerConfig)(nil),     // 3: aura.proxy.shadowsocks_2022.RelayServerConfig
	(*Account)(nil),               // 4: aura.proxy.shadowsocks_2022.Account
	(*ClientConfig)(nil),          // 5: aura.proxy.shadowsocks_2022.ClientConfig
	(net.Network)(0),              // 6: aura.common.net.Network
	(*protocol.User)(nil),         // 7: aura.common.protocol.User
	(*net.IPOrDomain)(nil),        // 8: aura.common.net.IPOrDomain
}
var file_proxy_shadowsocks_2022_config_proto_depIdxs = []int32{
	6, // 0: aura.proxy.shadowsocks_2022.ServerConfig.network:type_name -> aura.common.net.Network
	7, // 1: aura.proxy.shadowsocks_2022.MultiUserServerConfig.users:type_name -> aura.common.protocol.User
	6, // 2: aura.proxy.shadowsocks_2022.MultiUserServerConfig.network:type_name -> aura.common.net.Network
	8, // 3: aura.proxy.shadowsocks_2022.RelayDestination.address:type_name -> aura.common.net.IPOrDomain
	2, // 4: aura.proxy.shadowsocks_2022.RelayServerConfig.destinations:type_name -> aura.proxy.shadowsocks_2022.RelayDestination
	6, // 5: aura.proxy.shadowsocks_2022.RelayServerConfig.network:type_name -> aura.common.net.Network
	8, // 6: aura.proxy.shadowsocks_2022.ClientConfig.address:type_name -> aura.common.net.IPOrDomain
