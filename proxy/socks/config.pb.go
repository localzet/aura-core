...
type ServerConfig struct {
	...
	AuthType   AuthType          `protobuf:"varint,1,opt,name=auth_type,json=authType,proto3,enum=aura.proxy.socks.AuthType" json:"auth_type,omitempty"`
...
var file_proxy_socks_config_proto_goTypes = []any{
	(AuthType)(0),                   // 0: aura.proxy.socks.AuthType
	(*Account)(nil),                 // 1: aura.proxy.socks.Account
	(*ServerConfig)(nil),            // 2: aura.proxy.socks.ServerConfig
	(*ClientConfig)(nil),            // 3: aura.proxy.socks.ClientConfig
	nil,                             // 4: aura.proxy.socks.ServerConfig.AccountsEntry
	(*net.IPOrDomain)(nil),          // 5: aura.common.net.IPOrDomain
	(*protocol.ServerEndpoint)(nil), // 6: aura.common.protocol.ServerEndpoint
}
var file_proxy_socks_config_proto_depIdxs = []int32{
	0, // 0: aura.proxy.socks.ServerConfig.auth_type:type_name -> aura.proxy.socks.AuthType
	4, // 1: aura.proxy.socks.ServerConfig.accounts:type_name -> aura.proxy.socks.ServerConfig.AccountsEntry
	5, // 2: aura.proxy.socks.ServerConfig.address:type_name -> aura.common.net.IPOrDomain
	6, // 3: aura.proxy.socks.ClientConfig.server:type_name -> aura.common.protocol.ServerEndpoint
