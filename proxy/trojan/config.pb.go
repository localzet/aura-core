...
var file_proxy_trojan_config_proto_goTypes = []any{
	(*Account)(nil),                 // 0: aura.proxy.trojan.Account
	(*Fallback)(nil),                // 1: aura.proxy.trojan.Fallback
	(*ClientConfig)(nil),            // 2: aura.proxy.trojan.ClientConfig
	(*ServerConfig)(nil),            // 3: aura.proxy.trojan.ServerConfig
	(*protocol.ServerEndpoint)(nil), // 4: aura.common.protocol.ServerEndpoint
	(*protocol.User)(nil),           // 5: aura.common.protocol.User
}
var file_proxy_trojan_config_proto_depIdxs = []int32{
	4, // 0: aura.proxy.trojan.ClientConfig.server:type_name -> aura.common.protocol.ServerEndpoint
	5, // 1: aura.proxy.trojan.ServerConfig.users:type_name -> aura.common.protocol.User
	1, // 2: aura.proxy.trojan.ServerConfig.fallbacks:type_name -> aura.proxy.trojan.Fallback
