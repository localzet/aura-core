...
var file_proxy_vless_inbound_config_proto_goTypes = []any{
	(*Fallback)(nil),      // 0: aura.proxy.vless.inbound.Fallback
	(*Config)(nil),        // 1: aura.proxy.vless.inbound.Config
	(*protocol.User)(nil), // 2: aura.common.protocol.User
}
var file_proxy_vless_inbound_config_proto_depIdxs = []int32{
	2, // 0: aura.proxy.vless.inbound.Config.clients:type_name -> aura.common.protocol.User
	0, // 1: aura.proxy.vless.inbound.Config.fallbacks:type_name -> aura.proxy.vless.inbound.Fallback
