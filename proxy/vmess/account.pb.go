...
var file_proxy_vmess_account_proto_goTypes = []any{
	(*Account)(nil),                 // 0: aura.proxy.vmess.Account
	(*protocol.SecurityConfig)(nil), // 1: aura.common.protocol.SecurityConfig
}
var file_proxy_vmess_account_proto_depIdxs = []int32{
	1, // 0: aura.proxy.vmess.Account.security_settings:type_name -> aura.common.protocol.SecurityConfig
