...
var file_proxy_vmess_inbound_config_proto_goTypes = []any{
	(*DetourConfig)(nil),  // 0: aura.proxy.vmess.inbound.DetourConfig
	(*DefaultConfig)(nil), // 1: aura.proxy.vmess.inbound.DefaultConfig
	(*Config)(nil),        // 2: aura.proxy.vmess.inbound.Config
	(*protocol.User)(nil), // 3: aura.common.protocol.User
}
var file_proxy_vmess_inbound_config_proto_depIdxs = []int32{
	3, // 0: aura.proxy.vmess.inbound.Config.user:type_name -> aura.common.protocol.User
	1, // 1: aura.proxy.vmess.inbound.Config.default:type_name -> aura.proxy.vmess.inbound.DefaultConfig
	0, // 2: aura.proxy.vmess.inbound.Config.detour:type_name -> aura.proxy.vmess.inbound.DetourConfig
