...
var file_proxy_vmess_outbound_config_proto_goTypes = []any{
	(*Config)(nil),                  // 0: aura.proxy.vmess.outbound.Config
	(*protocol.ServerEndpoint)(nil), // 1: aura.common.protocol.ServerEndpoint
}
var file_proxy_vmess_outbound_config_proto_depIdxs = []int32{
	1, // 0: aura.proxy.vmess.outbound.Config.Receiver:type_name -> aura.common.protocol.ServerEndpoint
