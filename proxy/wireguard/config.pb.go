...
type DeviceConfig struct {
	...
	DomainStrategy DeviceConfig_DomainStrategy `protobuf:"varint,7,opt,name=domain_strategy,json=domainStrategy,proto3,enum=aura.proxy.wireguard.DeviceConfig_DomainStrategy" json:"domain_strategy,omitempty"`
...
var file_proxy_wireguard_config_proto_goTypes = []any{
	(DeviceConfig_DomainStrategy)(0), // 0: aura.proxy.wireguard.DeviceConfig.DomainStrategy
	(*PeerConfig)(nil),               // 1: aura.proxy.wireguard.PeerConfig
	(*DeviceConfig)(nil),             // 2: aura.proxy.wireguard.DeviceConfig
}
var file_proxy_wireguard_config_proto_depIdxs = []int32{
	1, // 0: aura.proxy.wireguard.DeviceConfig.peers:type_name -> aura.proxy.wireguard.PeerConfig
	0, // 1: aura.proxy.wireguard.DeviceConfig.domain_strategy:type_name -> aura.proxy.wireguard.DeviceConfig.DomainStrategy
