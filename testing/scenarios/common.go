...
import (
	...
	"github.com/localzet/aura/common/units"
...
func InitializeServerConfig(config *core.Config) (*exec.Cmd, error) {
	...
	proc := RunAuraProtobuf(configBytes)
...
func genTestBinaryPath() {
	testBinaryPathGen.Do(func() {
		...
		file := filepath.Join(tempDir, "aura.test")
...
func GetSourcePath() string {
	return filepath.Join("github.com", "localzet", "aura", "main")
}
