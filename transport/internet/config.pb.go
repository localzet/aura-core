...
type SocketConfig struct {
	...
	Tproxy SocketConfig_TProxyMode `protobuf:"varint,3,opt,name=tproxy,proto3,enum=aura.transport.internet.SocketConfig_TProxyMode" json:"tproxy,omitempty"`
	...
	DomainStrategy             DomainStrategy      `protobuf:"varint,8,opt,name=domain_strategy,json=domainStrategy,proto3,enum=aura.transport.internet.DomainStrategy" json:"domain_strategy,omitempty"`
	...
	AddressPortStrategy        AddressPortStrategy `protobuf:"varint,21,opt,name=address_port_strategy,json=addressPortStrategy,proto3,enum=aura.transport.internet.AddressPortStrategy" json:"address_port_strategy,omitempty"`
}
...
var file_transport_internet_config_proto_goTypes = []any{
	(DomainStrategy)(0),          // 0: aura.transport.internet.DomainStrategy
	(AddressPortStrategy)(0),     // 1: aura.transport.internet.AddressPortStrategy
	(SocketConfig_TProxyMode)(0), // 2: aura.transport.internet.SocketConfig.TProxyMode
	(*TransportConfig)(nil),      // 3: aura.transport.internet.TransportConfig
	(*StreamConfig)(nil),         // 4: aura.transport.internet.StreamConfig
	(*ProxyConfig)(nil),          // 5: aura.transport.internet.ProxyConfig
	(*CustomSockopt)(nil),        // 6: aura.transport.internet.CustomSockopt
	(*SocketConfig)(nil),         // 7: aura.transport.internet.SocketConfig
	(*serial.TypedMessage)(nil),  // 8: aura.common.serial.TypedMessage
	(*net.IPOrDomain)(nil),       // 9: aura.common.net.IPOrDomain
}
var file_transport_internet_config_proto_depIdxs = []int32{
	8, // 0: aura.transport.internet.TransportConfig.settings:type_name -> aura.common.serial.TypedMessage
	9, // 1: aura.transport.internet.StreamConfig.address:type_name -> aura.common.net.IPOrDomain
	3, // 2: aura.transport.internet.StreamConfig.transport_settings:type_name -> aura.transport.internet.TransportConfig
	8, // 3: aura.transport.internet.StreamConfig.security_settings:type_name -> aura.common.serial.TypedMessage
	7, // 4: aura.transport.internet.StreamConfig.socket_settings:type_name -> aura.transport.internet.SocketConfig
	2, // 5: aura.transport.internet.SocketConfig.tproxy:type_name -> aura.transport.internet.SocketConfig.TProxyMode
	0, // 6: aura.transport.internet.SocketConfig.domain_strategy:type_name -> aura.transport.internet.DomainStrategy
	6, // 7: aura.transport.internet.SocketConfig.customSockopt:type_name -> aura.transport.internet.CustomSockopt
	1, // 8: aura.transport.internet.SocketConfig.address_port_strategy:type_name -> aura.transport.internet.AddressPortStrategy
