...
var file_transport_internet_grpc_encoding_stream_proto_goTypes = []any{
	(*Hunk)(nil),      // 0: aura.transport.internet.grpc.encoding.Hunk
	(*MultiHunk)(nil), // 1: aura.transport.internet.grpc.encoding.MultiHunk
}
var file_transport_internet_grpc_encoding_stream_proto_depIdxs = []int32{
	0, // 0: aura.transport.internet.grpc.encoding.GRPCService.Tun:input_type -> aura.transport.internet.grpc.encoding.Hunk
	1, // 1: aura.transport.internet.grpc.encoding.GRPCService.TunMulti:input_type -> aura.transport.internet.grpc.encoding.MultiHunk
	0, // 2: aura.transport.internet.grpc.encoding.GRPCService.Tun:output_type -> aura.transport.internet.grpc.encoding.Hunk
	1, // 3: aura.transport.internet.grpc.encoding.GRPCService.TunMulti:output_type -> aura.transport.internet.grpc.encoding.MultiHunk
