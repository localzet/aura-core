...
const (
	GRPCService_Tun_FullMethodName      = "/aura.transport.internet.grpc.encoding.GRPCService/Tun"
	GRPCService_TunMulti_FullMethodName = "/aura.transport.internet.grpc.encoding.GRPCService/TunMulti"
)
...
var GRPCService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "aura.transport.internet.grpc.encoding.GRPCService",
