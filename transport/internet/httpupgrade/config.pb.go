...
var file_transport_internet_httpupgrade_config_proto_goTypes = []any{
	(*Config)(nil), // 0: aura.transport.internet.httpupgrade.Config
	nil,            // 1: aura.transport.internet.httpupgrade.Config.HeaderEntry
}
var file_transport_internet_httpupgrade_config_proto_depIdxs = []int32{
	1, // 0: aura.transport.internet.httpupgrade.Config.header:type_name -> aura.transport.internet.httpupgrade.Config.HeaderEntry
