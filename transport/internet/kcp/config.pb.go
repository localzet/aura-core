...
var file_transport_internet_kcp_config_proto_goTypes = []any{
	(*MTU)(nil),                 // 0: aura.transport.internet.kcp.MTU
	(*TTI)(nil),                 // 1: aura.transport.internet.kcp.TTI
	(*UplinkCapacity)(nil),      // 2: aura.transport.internet.kcp.UplinkCapacity
	(*DownlinkCapacity)(nil),    // 3: aura.transport.internet.kcp.DownlinkCapacity
	(*WriteBuffer)(nil),         // 4: aura.transport.internet.kcp.WriteBuffer
	(*ReadBuffer)(nil),          // 5: aura.transport.internet.kcp.ReadBuffer
	(*ConnectionReuse)(nil),     // 6: aura.transport.internet.kcp.ConnectionReuse
	(*EncryptionSeed)(nil),      // 7: aura.transport.internet.kcp.EncryptionSeed
	(*Config)(nil),              // 8: aura.transport.internet.kcp.Config
	(*serial.TypedMessage)(nil), // 9: aura.common.serial.TypedMessage
}
var file_transport_internet_kcp_config_proto_depIdxs = []int32{
	0, // 0: aura.transport.internet.kcp.Config.mtu:type_name -> aura.transport.internet.kcp.MTU
	1, // 1: aura.transport.internet.kcp.Config.tti:type_name -> aura.transport.internet.kcp.TTI
	2, // 2: aura.transport.internet.kcp.Config.uplink_capacity:type_name -> aura.transport.internet.kcp.UplinkCapacity
	3, // 3: aura.transport.internet.kcp.Config.downlink_capacity:type_name -> aura.transport.internet.kcp.DownlinkCapacity
	4, // 4: aura.transport.internet.kcp.Config.write_buffer:type_name -> aura.transport.internet.kcp.WriteBuffer
	5, // 5: aura.transport.internet.kcp.Config.read_buffer:type_name -> aura.transport.internet.kcp.ReadBuffer
	9, // 6: aura.transport.internet.kcp.Config.header_config:type_name -> aura.common.serial.TypedMessage
	7, // 7: aura.transport.internet.kcp.Config.seed:type_name -> aura.transport.internet.kcp.EncryptionSeed
