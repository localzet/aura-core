...
var file_transport_internet_splithttp_config_proto_goTypes = []any{
	(*RangeConfig)(nil),           // 0: aura.transport.internet.splithttp.RangeConfig
	(*XmuxConfig)(nil),            // 1: aura.transport.internet.splithttp.XmuxConfig
	(*Config)(nil),                // 2: aura.transport.internet.splithttp.Config
	nil,                           // 3: aura.transport.internet.splithttp.Config.HeadersEntry
	(*internet.StreamConfig)(nil), // 4: aura.transport.internet.StreamConfig
}
var file_transport_internet_splithttp_config_proto_depIdxs = []int32{
	0,  // 0: aura.transport.internet.splithttp.XmuxConfig.maxConcurrency:type_name -> aura.transport.internet.splithttp.RangeConfig
	0,  // 1: aura.transport.internet.splithttp.XmuxConfig.maxConnections:type_name -> aura.transport.internet.splithttp.RangeConfig
	0,  // 2: aura.transport.internet.splithttp.XmuxConfig.cMaxReuseTimes:type_name -> aura.transport.internet.splithttp.RangeConfig
	0,  // 3: aura.transport.internet.splithttp.XmuxConfig.hMaxRequestTimes:type_name -> aura.transport.internet.splithttp.RangeConfig
	0,  // 4: aura.transport.internet.splithttp.XmuxConfig.hMaxReusableSecs:type_name -> aura.transport.internet.splithttp.RangeConfig
	3,  // 5: aura.transport.internet.splithttp.Config.headers:type_name -> aura.transport.internet.splithttp.Config.HeadersEntry
	0,  // 6: aura.transport.internet.splithttp.Config.xPaddingBytes:type_name -> aura.transport.internet.splithttp.RangeConfig
	0,  // 7: aura.transport.internet.splithttp.Config.scMaxEachPostBytes:type_name -> aura.transport.internet.splithttp.RangeConfig
	0,  // 8: aura.transport.internet.splithttp.Config.scMinPostsIntervalMs:type_name -> aura.transport.internet.splithttp.RangeConfig
	0,  // 9: aura.transport.internet.splithttp.Config.scStreamUpServerSecs:type_name -> aura.transport.internet.splithttp.RangeConfig
	1,  // 10: aura.transport.internet.splithttp.Config.xmux:type_name -> aura.transport.internet.splithttp.XmuxConfig
	4,  // 11: aura.transport.internet.splithttp.Config.downloadSettings:type_name -> aura.transport.internet.StreamConfig
