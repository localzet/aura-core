...
var file_transport_internet_tcp_config_proto_goTypes = []any{
	(*Config)(nil),              // 0: aura.transport.internet.tcp.Config
	(*serial.TypedMessage)(nil), // 1: aura.common.serial.TypedMessage
}
var file_transport_internet_tcp_config_proto_depIdxs = []int32{
	1, // 0: aura.transport.internet.tcp.Config.header_settings:type_name -> aura.common.serial.TypedMessage
