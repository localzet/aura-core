...
type Certificate struct {
	...
	Usage        Certificate_Usage `protobuf:"varint,3,opt,name=usage,proto3,enum=aura.transport.internet.tls.Certificate_Usage" json:"usage,omitempty"`
...
var file_transport_internet_tls_config_proto_goTypes = []any{
	(Certificate_Usage)(0), // 0: aura.transport.internet.tls.Certificate.Usage
	(*Certificate)(nil),    // 1: aura.transport.internet.tls.Certificate
	(*Config)(nil),         // 2: aura.transport.internet.tls.Config
}
var file_transport_internet_tls_config_proto_depIdxs = []int32{
	0, // 0: aura.transport.internet.tls.Certificate.usage:type_name -> aura.transport.internet.tls.Certificate.Usage
	1, // 1: aura.transport.internet.tls.Config.certificate:type_name -> aura.transport.internet.tls.Certificate
