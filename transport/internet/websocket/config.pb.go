...
var file_transport_internet_websocket_config_proto_goTypes = []any{
	(*Config)(nil), // 0: aura.transport.internet.websocket.Config
	nil,            // 1: aura.transport.internet.websocket.Config.HeaderEntry
}
var file_transport_internet_websocket_config_proto_depIdxs = []int32{
	1, // 0: aura.transport.internet.websocket.Config.header:type_name -> aura.transport.internet.websocket.Config.HeaderEntry
